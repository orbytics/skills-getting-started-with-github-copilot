...
# DELETE endpoint for removing a participant
...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 15,
        "participants": ["james@mergington.edu", "luke@mergington.edu"]
    },
    "Tennis Club": {
        "description": "Tennis instruction and tournament preparation",
